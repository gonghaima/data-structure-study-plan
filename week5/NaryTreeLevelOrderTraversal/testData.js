/**
 * Test data for N-ary Tree Level Order Traversal
...
const testData = {
    basicFunctionality: [
        ...
        },
        {
            ...
            // 3's children=[6,7], 4's children=[8], 5's children=[9,10]
    ...
    performanceTests: [
        {
            ...
            expected: (() => {
                const level1 = [1];
                const level2 = Array.from({ length: 100 }, (_, i) => i + 2);
                const level3 = [];
                for (let i = 0; i < 100; i++) {
                    for (let j = 0; j < 10; j++) {
                        level3.push((i + 2) * 100 + j);
                    }
                }
